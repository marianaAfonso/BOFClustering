...
class WordFilterMaxMin:
    def __init__(self, _maxThres, _minThres): 
    ...
    def applyFilter(self, hist,n_words,n_images):
        ...
        for i in range(0,n_words):
            ...
            if word_freq > self.maxThres or word_freq < self.minThres:
    ...
    def writeFile(self,f):
        f.write("Feature selection method MaxMin with parameters: ")
